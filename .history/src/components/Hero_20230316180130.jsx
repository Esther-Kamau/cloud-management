      ...
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-between px-5">
            <p className="flex px-4 py-2 text-slate-600"><CloudUploadIcon  className="h-6 t" /> App Security</p>
            <p className="flex px-4 py-2 text-slate-600"><DatabaseIcon className="h-6 t" /> Dashboard Designs</p>
            <p className="flex px-4 py-2 text-slate-600"><ServerIcon className="h-6 t"/> Cloud Data</p>
            <p className="flex px-4 py-2 text-slate-600"><PaperAirplaneIcon className="h-6 t"/> API</p>
          </div>
        </div>
      </div>
    </div>
