      ...
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-between px-5">
            <p className="flex px-4 py-2 text-slate-600"><CloudUploadIcon /> App Security</p>
            <p className="flex px-4 py-2 text-slate-600"><DatabaseIcon Dashboard Designs</p>
            <p className="flex px-4 py-2 text-slate-600"><ServerIcon /> Cloud Data</p>
            <p className="flex px-4 py-2 text-slate-600"><PaperAirplaneIcon/> API</p>
          </div>
        </div>
      </div>
    </div>
