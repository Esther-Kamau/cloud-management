      ...
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-between px-5">
            <p className="flex px-4">Icon. App Security</p>
            <p className="flex px-4">Icon. Dashboard Designs</p>
            <p className="flex px-4">Icon. Cloud Data</p>
            <p className="flex px-4">Icon. API</p>
          </div>
        </div>
      </div>
    </div>
