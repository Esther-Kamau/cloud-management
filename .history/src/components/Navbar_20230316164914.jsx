  ...
  return (
    <div className="w-screen h-[100px] z-10 bg-blue-900 fixed drop-shadow-lg">
      ...
      <ul className="absolute bg-blue-900 w-full px-8">
        <li className="border-b-2 border-blue">Home</li>
        <li className="border-b-2 border-blue">About</li>
        <li className="border-b-2 border-blue">Support</li>
        <li className="border-b-2 border-blue">Platforms</li>
        <li className="border-b-2 border-blue">Pricing</li>
      </ul>
    </div>
  );
};
