  ...
  return (
    <div className="w-screen h-[100px] z-10 bg-blue-900 fixed drop-shadow-lg">
      ...
      <ul className="absolute bg-blue-900 w-full px-8">
        <li className="border-b-2 border-">Home</li>
        <li className="border-b-2 border-">About</li>
        <li className="border-b-2 border-">Support</li>
        <li className="border-b-2 border-">Platforms</li>
        <li className="border-b-2 border-">Pricing</li>
      </ul>
    </div>
  );
};
