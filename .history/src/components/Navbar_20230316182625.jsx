...
{!nav ? <MenuIcon className="w-8 stroke-white" /> : <XIcon className="w-8 stroke-white" />}
      ...
      <div className="flex flex-col my-4">
        <button className="bg-transparent text-white px-6 py-3 mb-4 hover:bg-slate-200 hover:text-black ">Sign In</button>
        <button className="px- py-3" >Sign Up</button>
      </div>
      </ul>
    </div>
  );
