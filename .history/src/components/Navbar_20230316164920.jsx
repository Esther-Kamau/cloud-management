  ...
  return (
    <div className="w-screen h-[100px] z-10 bg-blue-900 fixed drop-shadow-lg">
      ...
      <ul className="absolute bg-blue-900 w-full px-8">
        <li className="border-b-2 border-blue-200 ">Home</li>
        <li className="border-b-2 border-blue-200 ">About</li>
        <li className="border-b-2 border-blue-200 ">Support</li>
        <li className="border-b-2 border-blue-200 ">Platforms</li>
        <li className="border-b-2 border-blue-200 ">Pricing</li>
      </ul>
    </div>
  );
};
