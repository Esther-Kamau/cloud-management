      ...
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-between px-5">
            <p className="flex px-4 py-2 text-slate-600"><CloudUploadIcon  className="" /> App Security</p>
            <p className="flex px-4 py-2 text-slate-600"><DatabaseIcon className="" /> Dashboard Designs</p>
            <p className="flex px-4 py-2 text-slate-600"><ServerIcon className=""/> Cloud Data</p>
            <p className="flex px-4 py-2 text-slate-600"><PaperAirplaneIcon className=""/> API</p>
          </div>
        </div>
      </div>
    </div>
